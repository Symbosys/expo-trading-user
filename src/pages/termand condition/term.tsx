...
const TermsOfService = () => {
  const sections = [
    ...
    { 
      ...
      content: `Refunds are not available for trading losses or fees once processed. Withdrawals are subject to verification, minimum amounts, and network fees. Processing times vary (e.g., 1-5 business days). We reserve the right to delay or reject suspicious requests.` 
    },
    { 
      id: 'ai', 
