...
const PrivacyPolicy = () => {
  ...
  return (
    <>
      <Navbar />
      {/* The Footer is placed inside this main div so it inherits 
      ...
      */}
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white py-12 px-4 sm:px-6 lg:px-8 mt-16">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-16 text-center m-1">
            <p className="text-gray-400 text-base font-bold bg-gray-800/30 rounded-lg p-2 border border-gray-600/50">
